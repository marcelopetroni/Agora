			...
			<div className='ag-flex ag-relative ag-items-center ag-w-full ag-flex-col lg:ag-flex-row lg:ag-justify-between'>  {/* ag-fixed ag-bg-bege ag-pr-20 ag-pl-20 ag-pt-14 ag-pb-16 ag-h-10 ag-top-0 ag-left-0 ag-rounded-xl */}
				...
				<div className='ag-flex ag-gap-4 ag-items-center ag-mt-4'>
					<a
						...
						className='ag-flex ag-text-xl ag-text-darkpurple ag-font-bold ag-font-amiko ag-px-10 ag-rounded-3xl ag-tracking-wide g-transition-transform ag-duration-300 hover:ag-scale-110 md:ag-text-2xl'>
						LOGIN
					</a>
					<a
						href="#register"
						onClick={() => setActiveView('register')}
						className='ag-flex ag-text-lg ag-font-medium ag-font-amiko ag-border-4 ag-border-darkpurple ag-w-36 ag-justify-center ag-tracking-wide ag-p-1 ag-rounded-3xl ag-bg-darkpurple ag-text-white ag-shadow-xl g-transition-transform ag-duration-300 hover:ag-scale-110 md:ag-text-2xl md:ag-px-6 md:ag-w-auto'>
						Cadastre-se
					</a>
				</div>
			</div>
		{/* Seção 1 Comece agora */}
			<div className='ag-flex ag-relative ag-flex-col ag-justify-between ag-mt-10 md:ag-flex-row md:ag-mt-1'>
				<div className='ag-ml-2 ag-pt-14 ag-w-full lg:ag-ml-32 lg:ag-pt-32 2xl:ag-pt-52 2xl:ag-ml-48'>
					...
					<h2 className='ag-font-amiko ag-font-medium ag-text-3xl ag-text-darkpurple md:ag-text-5xl'>
						para artistas e suas
					</h2>
					<h2 className='ag-font-amiko ag-font-medium ag-text-3xl ag-text-darkpurple md:ag-text-5xl'>
						trajetórias criativas.
					</h2>
					<p className='ag-font-amiko ag-font-medium ag-text-sm ag-text-darkpurple md:ag-text-xl'>
						Conecte-se a oportunidades, capacitação
					</p>
					<p className='ag-font-amiko ag-font-medium ag-text-sm ag-text-darkpurple md:ag-text-xl'>
						e tecnologia tudo em um só lugar.
					</p>
					<a href="/login" className='ag-flex ag-text-lg md:ag-text-2xl ag-font-normal ag-font-amiko ag-border-4 ag-border-darkpurple ag-px-8 ag-py-3 ag-w-fit ag-mt-6 ag-rounded-2xl ag-bg-darkpurple ag-text-white ag-shadow-xl g-transition-transform ag-duration-300 hover:ag-scale-110'>
						Comece agora!
					</a>
				</div>
				...
				<div className='ag-relative ag-flex ag-flex-col ag-justify-center ag-items-center ag-mb-24 ag-mt-16'>
					...
					<div className='ag-pt-10 ag-mt-10 ag-pb-10 ag-bg-lightpurple ag-rounded-xl ag-shadow-2xl ag-justify-center ag-items-center'>
						<div className='ag-flex ag-flex-col lg:ag-flex-row'>
							...
							<h1 className='ag-text-amiko ag-font-bold ag-text-white ag-text-xl ag-justify-self-center md:ag-text-2xl'>
								Missão
							</h1>
							<div className='ag-mt-5 ag-pl-52 ag-pr-52 ag-w-full lg:ag-border-t'></div>
							<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider ag-mt-5'>
								Conectar 10.000 usuários no portal
							</p>
							<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider'>
								Ágora dando acesso a ferramentas
							</p>
							<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider'>
								que impulsionam a criatividade e a
							</p>
							<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider'>
								inovação no mercado global das
							</p>
							<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider'>
							...
							<div className='ag-mt-5 ag-pl-52 ag-pr-52 ag-w-full lg:ag-border-t'></div>
							<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider ag-mt-5'>
								Ser a principal plataforma para descoberta
							</p>
							<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider'>
								e promoção de talentos artísticos,
							</p>
							<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider'>
								utilizando tecnologias avançadas para
							</p>
							<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider'>
								criar um ecossistema artístico inclusivo.
							</p>
							</div>
							<div className='ag-flex ag-flex-col ag-items-center ag-mt-10 lg:ag-mt-0'>
								<h1 className='ag-text-amiko ag-font-bold ag-text-white ag-text-xl ag-justify-self-center md:ag-text-2xl'>
								...
								<div className='ag-mt-5 ag-pl-52 ag-pr-52 ag-w-full lg:ag-border-t'></div>
								<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider ag-mt-5'>
									Inovação e inclusão são nossos
								</p>
								<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider'>
									principais valores para fortalecer
								</p>
								<p className='ag-text-amiko ag-font-normal ag-text-white ag-text-sm ag-justify-self-center md:ag-text-xl ag-tracking-wider'>
									o mercado artístico mundial.
								</p>
							</div>
						</div>
					</div>
