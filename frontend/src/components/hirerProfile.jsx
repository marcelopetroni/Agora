    ...
    <div className='ag-flex ag-flex-col ag-my-10 ag-h-full'>
        ...
        <div className='ag-ml-20 ag-flex ag-flex-row ag-pt-20'>
            <div className='ag-pr-20'>
                <img src="https://placehold.co/400" alt="" className='ag-h-fit ag-w-64 ag-rounded-full' />
            </div>
            <div className='ag-flex ag-flex-col ag-gap-4'>
                ...
                <div className='ag-flex ag-justify-center ag-items-center ag-self-end'>
                    <button className='ag-font-amiko ag-text-white ag-bg-lightpurple ag-p-3 ag-rounded-xl '>Mudar Senha</button>
                </div>
                </div>
                ...
                <div className='ag-grid ag-grid-cols-3 ag-gap-5'>
                    {/* Empresa */}
                    <div className="ag-flex ag-flex-col ag-gap-1 ag-w-full ag-font-semibold">
                ...
                <div className='ag-flex ag-flex-col ag-w-full'>
                    <div className="ag-flex ag-flex-col ag-justify-center ag-items-start ag-gap-1 ag-font-semibold ag-w-full">
                        <label className="text-small ag-ml-1">Mini Bio</label>
                            <textarea
                            placeholder="Escreva sua descrição aqui..."
                            rows="6" // Define a altura inicial do campo (pode ser ajustado)
                            className="ag-w-full ag-p-3 ag-border ag-rounded-lg ag-focus:outline-none ag-resize-none "
                        />
                    </div>
                </div>
                <div className='ag-flex ag-flex-row ag-gap-5 ag-justify-end ag-mt-10 ag-mb-10'>
