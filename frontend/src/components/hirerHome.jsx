...
const HirerHome = () => {
  ...
  // placeholders temporários, integrar com o banco
    ...
    return(
        <>        
            <div className='ag-flex ag-flex-row ag-my-10 ag-pb-10 ag-h-fit ag-justify-between ag-items-center ag-border-b ag-border-gray-300'>
                <div className='ag-flex ag-flex-col ag-ml-32'>
                  {/* integrar no do usuário */}
                ...
                <div className='ag-flex ag-h-fit ag-w-20 ag-rounded-full ag-mr-20'>
                  {/* integrar foto de perfil */}
            ...
            <div className='ag-mr-20 ag-ml-32'>
                ...
                <div className="ag-grid ag-grid-cols sm:ag-grid-cols-2 ag-gap-6 ag-mt-12 ag-mb-20">
                    {talents.map((t) => (
                      // componente dos cards, integrar lá
                        <ArtistCard
                            key={t.id}
                            name={t.name}
                            roles={t.roles}
